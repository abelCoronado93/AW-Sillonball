        ...
        <section id="main-content">
            <article>
                ...
                <div id="myModal" class="reveal-modal">
                    <form action="../services/servicesParseAdmin.php?&action=addTemp&idSerie=<?php echo $id; ?>" method="post">
                ...
                <div id="myModal2" class="reveal-modal">
                    ...
                    <a class="botonModal" href="../admin/serie.php?id=<?php echo $id; ?>">No</a>
                </div>
            </article> <!-- /article -->
...
<script>
    ...
    $("#siBorrarTemp").on("click", function () {
        $url = "../services/servicesParseAdmin.php?&action=deleteTemp&idTemp=" + idTemp + "&idSerie=" + <?php echo $id ?>;
        $.get($url);
