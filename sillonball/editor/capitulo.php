...
<body>
    ...
    <article>
        ...
        <?php
            echo '<form action="../services/servicesParseEditor.php?action=doComent&idCap='.$id.'" method="post">'
    ...
    <div id="myModal" class="reveal-modal">                
        ...
        <a class="botonModal" href="../editor/capitulo.php?idCap=<?php echo $id ?>"> No </a>
    </div>
    ...
    $("#siBorrar").on("click",function(){ 
        $url="../services/servicesParseEditor.php?&action=deleteComent&idCom="+idCom+"&idCap="+ <?php echo $id ?>;
        $.get($url);
    ...
    $("#siBorrarCap").on("click",function(){ 
        $url="../services/servicesParseEditor.php?&action=deleteCapitulo&idCap="+ <?php echo $id ?>;
        $.get($url);
       
        alert("Capítulo eliminado");
        window.location.href = "../editor/serie.php?id="+<?php echo $idS?>;
    });
    </script>
</body>
</html>
